...
/**
 * Obtains images and labels from a UByte dataset. If "data" and "labels" are
 * null, only the number of images is returned.
 *
 * @param image_filename The dataset file containing the images.
 * @param label_filename The dataset file containing the labels.
 * @param data The output dataset, a Dx1xHxW array (single channel, D is the
 * dataset size).
